							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( $bosa_university_noThumbnail ) ?>>
								<div class="post-inner">
									...
									if ( empty( $bosa_university_render_highlight_post_image_size ) ){
										if ( get_theme_mod( 'bosa_university_highlight_posts_slides_show', 3 ) == 2 ){
							        		$bosa_university_render_highlight_post_image_size = 'bosa-university-590-310';
							        	}else {
							        		$bosa_university_render_highlight_post_image_size = 'bosa-university-420-200';
										}
									}
